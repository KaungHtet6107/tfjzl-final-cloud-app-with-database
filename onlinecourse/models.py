...
class Question(models.Model):
    """
    Stores an exam question belonging to a course.
    """
    ...
    # Calculate whether the learner selected all correct
...
class Choice(models.Model):
    """
    Stores an answer choice belonging to a question.
    """
...
class Submission(models.Model):
    """
    Stores an exam submission made by an enrolled learner.

    One Enrollment can have multiple Submissions.
    One Submission can contain multiple Choices.
